            ...
            <div className="relative text-center mb-[30px] px-[16px] md:mb-0">
              <div className="-mt-14.5 md:mt-0">
                <div className="simple-profile-header flex flex-col both-center">
                  <div className="relative mt-[9px] h-[136px] w-[136px] flex both-center"></div>
            ...
            <div>
              <div className="pt-[35px] px-[0px] md:px-[16px]">
                ...
                <div className="px-[16px] md:px-0">
                  <div className="mb-[10px] w-fit text-zinc-600 font-medium">
                    소개
                  </div>
                  <div>
                    <div className="edit-content-box">
                      <div>
                        <div
                          translate="yes"
                          className="ProseMirror prose prose-zinc !max-w-none break-all tiptap"
                        >
                          <p>
                            {user?.nick}(@{user?.id}) 커미션{" "}
                          </p>
                          <ul>
                            <li>
                              <p>마감일 꼭 지켜서 작업합니다!</p>
            ...
            <section className="w-full">
              ...
              <section className="p-[20px] md:border md:rounded-4px">
                <div className="mt-4 flex flex-col gap-4">
                  <a
                    className="group relative flex gap-3 break-all"
                    href="/@mhe_com/21282"
                  >
                    <div className="h-full flex grow flex-col">
                      <div className="line-clamp-2 pr-5 text-sm font-bold sm:text-lg">
                        LD 커미션
                      </div>
                      <button className="bookmark-button group flex flex-none flex-col cursor-pointer items-center text-gray-600 absolute right-0 top-0.5">
                        <div className="flex both-center rounded-full transition">
                          ...
                          />
                          <label className="">
                            <i className="transition cursor-pointer h-[18px] w-[18px] text-gray-400 i-cc-bookmark-line"></i>
                          </label>
                        </div>
                      </button>
                      <div className="mt-1 max-h-[3.6em] flex flex-wrap gap-2 overflow-hidden">
                        <span className="text-xs rounded-full px-2 py-1 text-gray-500 flex-none bg-gray-100">
                          #그림
                        </span>
                        <span className="text-xs rounded-full px-2 py-1 text-gray-500 flex-none bg-gray-100">
                          #디자인
                      ...
                      <p className="line-clamp-1 grow text-sm text-zinc-500">
                        디자인부터 캐릭터 생성까지 ~ 커미션
                      </p>
                    </div>
                  </a>
